...
```{r boxtidwell, echo=FALSE}
#UN3_bxtdw = na.exclude(UN3)
boxTidwell(ModernC ~ Pop , other.x = ~ Change + PPgdp + Frate + Fertility + Purban, data=UN3)
#boxTidwell(ModernC ~ Pop + Fertility , other.x = ~ Change + PPgdp + Frate  + Purban, data=UN3)
#boxTidwell(ModernC ~ Pop + Purban  , other.x = ~ Change + PPgdp + Frate + Fertility , data=UN3)
```
