...
UN3_bxtdw2 = UN3_bxtdw
UN3_bxtdw2["ModernC"] = sqrt(UN3_bxtdw["ModernC"])
#boxTidwell()
```
...
\therefore \qquad X_{j}^T (I-H) Y = \sum{X_{i,j}}_{i=1}^n \hat \beta_0 + X_{j}^T (I-H) Y\\[1ex]
\sum{X_{i,j}}_{i=1}^n \hat \beta_0 = X_{j}^T (I-H) Y - X_{j}^T (I-H) Y = 0
\end{gather*}
